   ...
   <body id=page-top>
      <nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" id=mainNav>
         <div class="container px-5">
            <a class="navbar-brand fw-bold" href=#page-top>EPS Gangrena</a> <button class=navbar-toggler type=button data-bs-toggle=collapse data-bs-target=#navbarResponsive aria-controls=navbarResponsive aria-expanded=false aria-label="Toggle navigation">Menu <i class=bi-list></i></button>
            <div class="collapse navbar-collapse" id=navbarResponsive>
               <ul class="navbar-nav ms-auto me-4 my-3 my-lg-0">
                  <li class=nav-item><a class="nav-link me-lg-3" href="#">Bienvenido!</a></li>
               </ul>
            ...
            <div class="row gx-5 align-items-center">
               <div class=col-lg-6>
                  <div class="mb-5 mb-lg-0 text-center text-lg-start">
                     <h2 class="display-2 lh-1 mb-3">Conoce la mejor EPS </h2>
                     <p class="lead fw-normal text-muted mb-5">Aprende mas en sobre nosotros de lo que necesitas para tener un buen servicio</p>
         ...
         <div class="container px-5">
            <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
               <div class="col-12 col-lg-5">
                  <h2 class="display-4 lh-1 mb-4">Bienvenidos a la nueva era de la salud</h2>
      ...
      <footer class="bg-black text-center py-5">
         <div class="container px-5">
            <div class="text-white-50 small">
               <div class=mb-2>&copy; Gangrena 2022. All Rights Reserved.</div>
