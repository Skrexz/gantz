                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Bienvenido a tu gestionador de contenido, <% out.println(sesion.getAttribute("nombre")); %>.</li>
                        </ol>
                        <div class="card mb-4">
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Gangrena 2022</div>
                        </div>
                    </div>
                </footer>
            </div>
